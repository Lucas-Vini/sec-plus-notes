...
## Key stretching
Key stretching techniques are used to make a possibly weak key, tipically a password or passphrase, more secure against a brute force attack by increasing the resources (time and possibly space) it takes to test each possible key.
## Key exchange
